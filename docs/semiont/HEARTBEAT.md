...
>
> **2026-05-09 起新增 routine 飛輪 SSOT**：[ROUTINE.md](ROUTINE.md) 是 6 條 TWMD-prefix cron routine 的人類可讀 source of truth。修 routine 一律先改 ROUTINE.md 再 sync `.claude/scheduled-tasks/`，反向 = drift = silent killer (DNA #38 + DNA #54)。
