...
last_session: 'ecstatic-archimedes-112344-v5'
sister_docs:
  - 'HEARTBEAT.md'
  - 'ANATOMY.md'
  - 'DNA.md'
...
白天 chain：a (06h) → M (09h)，間隔 3 hr 給 contributor 早上 push commit 喘息空間。
...
prompt: |
  ...
  UNKNOWNS / DNA #15 自我進化 SOP — 找 ≥3 次出現但沒進 canonical SOP / cron / dashboard
  欄位的條目，提案儀器化動作）。
