---
title: 'Jensen Huang'
description: "From a Kentucky reform school to history's first $5 trillion company — how a toilet-scrubbing boy from Tainan bet on a future that took a decade to arrive"
date: 2026-03-25
tags:
  [
    'people',
...
> **Did you know?**
> At age fourteen, Jensen Huang appeared in _Sports Illustrated_ as a table tennis player.[^2] At that reform school, he joined the swim team and learned to play table tennis — using athletics to find a way to survive.
...
In 1992, the three began meeting secretly at a Denny's diner in east San Jose to draw up their business plan. Huang chose Denny's because it was "quieter than home and the coffee was cheap." On April 5, 1993, they formally incorporated NVIDIA.[^6] The company name derives from the Latin _invidia_ (envy), because Priem wanted competitors to "turn green with envy." Startup capital? $200 each — $600 total.
...
[^1]: [Oneida Baptist Institute — History](https://www.oneidaschool.org/about/history.cfm) — Founded in 1899 in the Appalachian mountains of Kentucky, initially serving impoverished mountain-area children and later expanded to accept youth in "difficult circumstances" at this Christian boarding school.

[^2]: [Sports Illustrated 2002 retrospective report](https://en.wikipedia.org/wiki/Jensen_Huang) — describes Huang's roommate at Oneida as "covered in knife scars and tattoos," and his appearance in the magazine at age fourteen as a table tennis player. (Indexed via Wikipedia.)

[^3]: [NVIDIA becomes first public company worth $5 trillion — TechCrunch, 2025/10/29](https://techcrunch.com/2025/10/29/nvidia-becomes-first-public-company-worth-5-trillion/) — On October 29, 2025, NVIDIA became the first listed company in history to surpass a $5 trillion market capitalization, driven by demand for AI chips.

[^4]: [Jensen Huang — Forbes Profile](https://www.forbes.com/profile/jensen-huang/) — Forbes real-time tracking of Huang's net worth; approximately $165 billion in early 2026, seventh in the world.

[^5]: [Jen-Hsun Huang Hall — Oneida Baptist Institute](https://www.oneidaschool.org/about/huanghall.cfm) — In 2019, Huang donated $2 million to Oneida Baptist Institute to build a girls' dormitory and classroom building named after him.

[^6]: [NVIDIA Articles of Incorporation, April 5, 1993 — SEC EDGAR](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1045810) — NVIDIA formally incorporated on April 5, 1993; SEC public registration document.

[^7]: [Stephen Witt, _The Nvidia Way_ (2025)](https://www.simonandschuster.com/books/The-Nvidia-Way/Stephen-Witt/9781668096048) — A deep biography documenting the chaos of the three founders who "had absolutely no idea how to run a company," the botched Don Valentine pitch, and Curtis Priem's recollection that "we listened to Jensen from day one."

[^8]: [Mark Zuckerberg Instagram, March 2024](https://www.instagram.com/zuck/) — Zuckerberg posted a photo of the two of them in each other's signature jackets, calling Huang "the Taylor Swift of tech."

[^9]: [Jensen Huang signs land-use agreement for NVIDIA Taiwan HQ — Taiwan News, 2026/01/29](https://www.taiwannews.com.tw/news/6277835) — In January 2026, Huang came to Taiwan to sign the Beitou-Shilin Technology Park land-use agreement, announcing plans for NVIDIA's new Taiwan headquarters.

[^10]: [Jensen Huang and Lisa Su family tree — Tom's Hardware](https://www.tomshardware.com/news/jensen-huang-and-lisa-su-family-tree-shows-how-closely-they-are-related) — Lisa Su's maternal grandfather is the elder brother of Huang's mother; the precise relationship is first cousin once removed, not simply "cousins."

[^11]: [The Wall Street Journal — Jensen Huang Profile, February 2024](https://www.wsj.com/tech/ai/nvidia-ceo-jensen-huang-ai-8a5fd5b0) — Reports on Huang's habit of not wearing a watch and his management philosophy.

[^12]: [NVIDIA Blog: Jensen Huang & Bill Dally awarded Queen Elizabeth Prize for Engineering](https://blogs.nvidia.com/blog/nvidia-founder-and-ceo-jensen-huang-and-chief-scientist-bill-dally-awarded-prestigious-queen-elizabeth-prize-for-engineering/) — The 2025 Queen Elizabeth Prize for Engineering was awarded to contributors in "modern machine learning," presented in person by King Charles III at St. James's Palace.
