...
- [Teach For Taiwan (TFT)](/en/Society/taiwan-slash-generation/) — TFT's ten-year organizational history, including the 3A framework (Access/Achievement/Aspiration) and the shortage of teachers in remote areas. This article's perspective echoes TFT's concentric circle framework, but shifts the focus from rural education generally to the specifics of indigenous education.
