---
title: 'Taiwan Game Jam Community'
description: "From Global Game Jam landing in Taiwan to KUSO GAME JAM adopting '废作' (junk-work) as philosophy — how Taiwan's Game Jam community became an incubator and testing ground for the independent game ecosystem over a decade"
date: 2026-04-27
category: 'Technology'
tags:
  - 'games'
...
[Global Game Jam](https://globalgamejam.org/) is the world's largest annual Game Jam event; Taiwan venues have been established one after another since around 2012.
...
**Social networking**: developers meet at Game Jam venues, forming horizontal connections across companies and schools; many subsequent collaborations began here. **Student entry point**: Game Jam is the occasion for many students to "complete a game under real constraints" for the first time — school courses rarely provide this kind of pressure. **Keeping people in the ecosystem**: some Game Jam participants from over ten years ago have since become full-time indie game developers. Nitrous Games developer Lee-Kuo Chen is one traceable example[^7] — from community participation to releasing an independent work, the Game Jam was one of the early nodes on that path.
...
1. Is there a deeper cultural connection between Taiwan's KUSO culture (Taiwanese kitsch, temple troupes, parody) and KUSO GAME JAM's "legitimacy of bad taste"?
2. To what extent does the indie game community's informal network (Game Jams, community events) substitute for formal industry cultivation mechanisms?
3. If a game can also be "stinky tofu," what kind of distribution platform or community mechanism could help such works find the right audience?

### Related Topics

- **→ [Taiwan Gaming Industry and Digital Entertainment](/zh-tw/technology/taiwan-gaming-industry)**
- **→ [Red Candle Games](/zh-tw/technology/red-candle-games)**
- **→ [Taiwan Open Source Spirit](/zh-tw/technology/taiwan-open-source-spirit)**

---

## Sources

[^1]: [First-hand account by tppr2046](https://github.com/tppr2046) — Founder of KUSO GAME JAM; provides the founding history of KUSO GAME JAM, records of each edition, records of hosting the Global Game Jam Taipei Second Venue (2016–2026), and content from the TGDF 2019 talk.

[^2]: [First-hand account by tppr2046](https://github.com/tppr2046) — Notes Faust Li (Li Chia-i, 1979–2014) as a pioneer of Taiwan's Game Jam community; co-organized with IGDSHARE the "MIT (Made in Taiwan) Game Jam" at Yuan Ze University in 2012, currently the earliest verifiable public Game Jam record in Taiwan.

[^3]: [IGDSHARE](https://igdshare.org/) — Host of the Global Game Jam Taipei First Venue; Johnson Lin served simultaneously as GGJ Asia regional director.

[^4]: [PooPooL on Google Play](https://play.google.com/store/apps/details?id=com.kusogamejam.poopool) — A 2017 KUSO GAME JAM work that was listed on the Google Play Store and has since been removed (link preserved as a historical record of the event's existence).

[^5]: [Diane Arbus, Wikipedia](https://zh.wikipedia.org/zh-tw/%E8%BF%AA%E5%AE%89%C2%B7%E9%98%BF%E5%B8%83%E6%96%AF) — 1923–1971; American photographer known for photographing society's marginal figures; cited as a "bad taste genealogy" coordinate in the TGDF 2019 talk.

[^6]: [HK97, Wikipedia](https://en.wikipedia.org/wiki/HK_97) — A 1995 Hong Kong-made Game Boy game, known for rough production and political satire; later became a historical reference point in kuso game culture.

[^7]: [Nitrous Games, Wikipedia](https://zh.wikipedia.org/zh-tw/%E6%97%A5%E9%A0%AD%E9%81%8A%E6%88%B2) — Developed by Lee-Kuo Chen; a Taiwanese indie game case; the developer was an early participant in Taiwan's Game Jam community.

---

_This article's primary material comes from first-hand accounts by KUSO GAME JAM founder tppr2046. For factual additions or corrections, please open a PR._
